...
class ClientBalanceMonthlyListExport implements FromQuery, WithHeadings, WithStyles, WithColumnWidths
{
    use Exportable;
    ...
    public function query()
    {
        ...
        $query = ClientBalance::selectRaw('
            ...
            ->whereMonth('client_balances.created_at', $currentMonth)
            ->whereYear('client_balances.created_at', $currentYear)
            ->distinct();
