...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        @foreach ([ 
            ...
            ['Today New Customer', $totalNewCustomerDaily, 'person_add'],
            
            ['Total Vender Payment', $totalVenderPaymentDaily, 'arrow_circle_up'],
        ] as $index => $card)
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card">
                    <div class="test1 card-header p-3">
    ...
    <div class="row mb-4">
        ...
        @foreach ([ 
            ...
            ['Weekly Withdrawal', $totalWithdrawalWeekly, 'arrow_downward'],
            ['Weekly Margin', $totalBalanceWeekly, 'account_balance_wallet'],

            ['Weekly Freez Amount', $totalFreezAmountWeekly, 'arrow_downward'],
            ['Weekly Bonus', $totalBonusWeekly, 'star'],


            ['Weekly Settling Points', $totalMasterSettlingWeekly, 'point_of_sale'],
            ['Weekly Expense', $totalExpenseWeekly, 'money_off'],
            ['Weekly Profit', $totalOwnerProfitWeekly, 'attach_money'],
            ['Weekly New Customers', $totalNewCustomerWeekly, 'group_add'],

            ['Total Vender Payment', $totalVenderPaymentWeekly, 'arrow_circle_up'],
        ] as $index => $card)
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card">
                    <div class="test1 card-header p-3">
    ...
    <div class="row mb-4">
        ...
        @foreach ([ 
            ...
            ['Total New Customer', $totalNewCustomerMonthly, 'person_add'],
            ['Total Vender Payment', $totalVenderPaymentMonthly, 'arrow_circle_up'],
