            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div
                            class="bg-gradient-warning shadow-warning border-radius-lg pt-4 d-flex justify-content-between align-items-center px-3">
                            <p style="color: black;"><strong>Freez Bank Balance (Weekly Bases)</strong></p>
                            <div>
                        ...
                        <div class="form-validation">
                            ...
                            <form id="bankForm" method="post"action="{{ route('exchange.bank.store') }}">
                                ...
                                <div class="row">
                                    {{-- <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3" hidden>
                                            <input type="text" class="form-control border" id="cash_type"value="minus"
                                                name="cash_type" readonly>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-warning" id="submitBankEntry">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
